...
name_on_order = streamlit.text_input ('Name of Smoothie: ')
...
#streamlit.text(smoothiefroot_response.json())
sf_df = streamlit.dataframe(data=smoothefroot_responce.json(), use_container_width=True)
